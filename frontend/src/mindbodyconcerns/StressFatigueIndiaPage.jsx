...
const pageLinks = [
  ...
  { label: "Stress Connection", id: "how-are-stress-and-fatigue-connected" },
  { label: "Physical & Mental", id: "understanding-physical-and-mental-fatigue" },
  { label: "Symptoms", id: "common-symptoms-associated-with-fatigue" },
  { label: "Causes", id: "common-causes-of-fatigue" },
  { label: "Warning Signs", id: "common-signs-you-should-not-ignore" },
  { label: "Assessment Process", id: "our-stress-and-fatigue-assessment-process" },
  { label: "Neuro-Ayurveda", id: "the-neuro-ayurveda-development-system" },
  { label: "Support Approach", id: "how-we-support-individuals-concerned-about-fatigue" },
...
const faqStart = rawSourceContent.search(/\n\s*1\.\s*Can stress cause fatigue\?/i);
const faqEnd = rawSourceContent.indexOf("\nConcerned About Stress and Persistent Fatigue?", faqStart);
...
const articleLinkRules = [
  ...
  { pattern: /\bStress & Fatigue\b/i, href: "/stress-and-fatigue" },
  { pattern: /\bFatigue\b/i, href: "/stress-and-fatigue" },
  { pattern: /\bMental Fatigue\b/i, href: "/stress-and-fatigue" },
  { pattern: /\bPhysical Fatigue\b/i, href: "/stress-and-fatigue" },
  { pattern: /\bsleep\b/i, href: "/sleep-disorders-treatment-india" },
  { pattern: /\bthyroid\b/i, href: "/stress-and-thyroid" },
  { pattern: /\banxiety\b/i, href: "/stress-anxiety-treatment-india" },
  { pattern: /\bdepression\b/i, href: "/adult-depression-treatment-india" },
  { pattern: /\bburnout\b/i, href: "/stress-and-burnout" },
...
function ContentSection({ section, sectionIndex, onCitationClick }) {
  ...
  const visualImage = section.id === "understanding-physical-and-mental-fatigue" ? mentalFatigueImage : section.id === "common-symptoms-associated-with-fatigue" || section.id === "common-causes-of-fatigue" ? lowEnergyImage : section.id === "the-neuro-ayurveda-development-system" ? neuroAyurvedaImage : section.id === "supporting-healthy-energy-levels" ? lifestyleImage : null;
      ...
      <div className="grid lg:grid-cols-[minmax(0,1fr)_360px]">
        ...
        <div className="bg-[#f3eadb] p-6 sm:p-8">
          ...
          <p className="mt-3 text-[13px] font-semibold leading-6 text-[#111827]">
            Join our mind-body health newsletter for stress, fatigue and energy wellbeing guidance.
          </p>
          ...
          <SidebarCard className="border-[#d8c6e5] bg-[#fcf9ff]">
            <a href="/about/doctor" className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-2 text-[12px] font-bold leading-5 text-[#75677d]">Clinical Focus: Mind-Body Health, Fatigue, Stress and Mental Health</p>
