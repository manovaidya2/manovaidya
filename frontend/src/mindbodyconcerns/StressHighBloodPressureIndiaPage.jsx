...
const pageLinks = [
  ...
  { label: "High Blood Pressure", id: "what-is-high-blood-pressure" },
  { label: "Stress Connection", id: "what-is-the-relationship-between-stress-and-blood-pressure" },
  { label: "Risk Factors", id: "common-risk-factors-for-high-blood-pressure" },
  { label: "Temporary vs Long-Term", id: "temporary-vs-long-term-high-blood-pressure" },
  { label: "Warning Signs", id: "common-signs-you-should-not-ignore" },
  { label: "Assessment Process", id: "our-stress-and-high-blood-pressure-assessment-process" },
  { label: "Neuro-Ayurveda", id: "the-neuro-ayurveda-development-system" },
  { label: "Support Approach", id: "how-we-support-individuals-concerned-about-stress-and-high-blood-pressure" },
  { label: "About Doctor", id: "about-dr-ankush-garg" },
  { label: "FAQs", id: "faqs" },
  { label: "Book Assessment", id: "book-assessment" },
];

const keyTakeawayEnd = rawSourceContent.search(/\n\s*Cardiovascular Wellbeing/);
...
const faqEnd = rawSourceContent.indexOf("\nConcerned About Stress and High Blood Pressure?", faqStart);
...
const articleSections = articleContent.split("\n").reduce(
  (sections, line) => {
    ...
    if (sectionHeadings.has(trimmed)) {
      sections.push({ title: trimmed, id: slugify(trimmed), lines: [] });
      return sections;
    }
...
const articleLinkRules = [
  ...
  { pattern: /\bStress & High Blood Pressure\b/i, href: "/stress-and-high-blood-pressure" },
  { pattern: /\bHigh Blood Pressure\b/i, href: "/stress-and-high-blood-pressure" },
  { pattern: /\bhypertension\b/i, href: "/stress-and-high-blood-pressure" },
  { pattern: /\bcardiovascular\b/i, href: "/mind-body-health-care-india" },
  { pattern: /\banxiety\b/i, href: "/stress-anxiety-treatment-india" },
  { pattern: /\bchronic stress\b/i, href: "/stress-and-burnout" },
  { pattern: /\bsleep\b/i, href: "/sleep-disorders-treatment-india" },
  { pattern: /\bdigestive\b/i, href: "/stress-and-digestive-health" },
...
function ContentSection({ section, sectionIndex, onCitationClick }) {
  ...
  const visualImage = section.id === "common-risk-factors-for-high-blood-pressure" ? refluxImage : section.id === "why-emotional-wellbeing-matters" ? gutBrainImage : section.id === "the-neuro-ayurveda-development-system" ? neuroAyurvedaImage : section.id === "supporting-healthy-blood-pressure" ? lifestyleImage : null;
  ...
  return (
    <section id={section.id} className="mt-9 scroll-mt-28">
      ...
      {visualImage && (
        <div className="mt-5 overflow-hidden rounded-lg border border-[#f4e6fa] bg-[#faf0fc] shadow-[0_10px_28px_rgba(139,67,186,0.06)]">
          <img src={visualImage} alt={section.title} className="h-[220px] w-full object-cover object-center" loading="lazy" decoding="async" />
        </div>
      )}
    ...
    <section className="mt-8 overflow-hidden rounded-[28px] bg-[#fbf5ef] shadow-[0_14px_30px_rgba(58,31,90,0.06)]">
      <div className="grid lg:grid-cols-[minmax(0,1fr)_360px]">
        <div className="p-6 sm:p-8">
          <p className="text-[11px] font-black uppercase tracking-[0.08em] text-[#8b43ba]">Cardiovascular Wellbeing</p>
        ...
        <div className="bg-[#f3eadb] p-6 sm:p-8">
          ...
          <p className="mt-3 text-[13px] font-semibold leading-6 text-[#111827]">
            Join our mind-body health newsletter for stress and cardiovascular wellbeing guidance.
          </p>
        ...
        <article className="min-w-0">
          ...
          <section id="faqs" className="mt-10">
            ...
            <div className="grid gap-3" itemScope itemType="https://schema.org/FAQPage">
              {faqs.map((faq, index) => (
                <div key={faq.question} className="overflow-hidden rounded-lg border border-[#f4e6fa] bg-white transition hover:border-[#8b43ba]" itemScope itemProp="mainEntity" itemType="https://schema.org/Question">
        ...
        <div className="hidden lg:block sticky top-24 max-h-[calc(100vh-6rem)] overflow-y-auto space-y-5 pb-5">
          <SidebarCard className="border-[#d8c6e5] bg-[#fcf9ff]">
            <a href="/about/doctor" className="flex items-start gap-3">
              <img src={doctorImage} alt="Dr Ankush Garg Manovaidya mind-body health clinician" className="h-12 w-12 shrink-0 rounded-full object-cover" loading="lazy" decoding="async" />
              <div>
                ...
                <p className="mt-2 text-[12px] font-bold leading-5 text-[#75677d]">Clinical Focus: Mind-Body Health, Mental Health and Lifestyle Wellbeing</p>
