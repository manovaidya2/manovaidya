...
import signsImage from "../images/mind-body-signs-man.png";

const signs = [
  { text: "Constant tiredness\neven after rest", Icon: Sparkles },
  { text: "Poor sleep or waking\nup unrefreshed", Icon: MoonStar },
  { text: "Frequent headaches\nor body pain", Icon: Brain },
  { text: "Digestive issues\nor bloating", Icon: Salad },
  { text: "Irritability or\nmood swings", Icon: CloudLightning },
  { text: "Difficulty focusing\nor brain fog", Icon: BookOpen },
  { text: "Low motivation\n& energy", Icon: BatteryLow },
  { text: "Unexplained weight\ngain or loss", Icon: Scale },
  { text: "Muscle tightness\nor stiffness", Icon: Dumbbell },
  { text: "Feeling stressed\nmost of the time", Icon: Activity },
];

function MindBodySignsSection() {
  return (
    <section className="overflow-hidden bg-[#fbf9ff] lg:pr-10">
      <div className="grid grid-cols-1 md:grid-cols-[200px_minmax(0,1fr)] lg:min-h-[260px] lg:grid-cols-[190px_minmax(0,1fr)_270px] xl:min-h-[240px] xl:grid-cols-[200px_minmax(0,1fr)_330px] 2xl:grid-cols-[220px_minmax(0,1fr)_380px]">
        <div className="flex items-start justify-start px-5 pb-3 pt-6 text-left sm:px-7 md:col-span-2 md:px-6 lg:col-span-3 lg:px-10 lg:pb-2 lg:pt-5">
          <div>
            <h2 className="text-[28px] font-black leading-[1.15] sm:text-[30px] lg:text-[30px] xl:text-[32px] 2xl:text-[34px]">
              <span className="text-[#18181b]">Signs You </span>
              <span className="text-[#8B43BA]">Shouldn&apos;t Ignore</span>
            </h2>
        ...
        <div className="relative min-h-[280px] overflow-hidden rounded-r-md sm:min-h-[340px] md:col-span-2 md:min-h-[360px] lg:col-span-1 lg:min-h-full">
          <img
            src={signsImage}
            alt="Man feeling tired and stressed at a desk"
...
export default MindBodySignsSection;
