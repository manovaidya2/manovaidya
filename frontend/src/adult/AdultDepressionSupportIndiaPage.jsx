...
const internalLinks = [
  ...
  { text: "Explore Stress & Burnout Treatment.", href: "/stress-burnout-support/" },
...
function ContentSection({ section }) {
  if (section.title === "Book a Consultation") {
    return <section id={section.id} className="mt-9 overflow-hidden rounded-lg border border-[#eadff1] bg-[#7835A4] text-white"><div className="p-6 sm:p-8"><h2 className="text-[22px] font-black leading-tight">Book a Consultation</h2><div className="mt-3 space-y-1">{section.lines.map((line) => <p key={line} className="text-[14px] font-semibold leading-7 text-[#e5d5f2]">{line}</p>)}</div><div className="mt-8 flex flex-wrap gap-4 border-t border-[#8e45bb] pt-6"><a href="tel:+917823838638" className="inline-flex h-12 items-center justify-center rounded-md bg-white px-8 text-[14px] font-black text-[#7835A4] transition hover:bg-[#fbf7ff]">Book Consultation</a><a href="tel:+917823838638" className="inline-flex h-12 items-center justify-center rounded-md border border-white px-8 text-[14px] font-black text-white transition hover:bg-[#632b86]">Take Mental Health Assessment</a></div></div><img src={ctaImage} alt="Adult depression and emotional wellbeing support" className="h-40 w-full object-cover object-center sm:h-52" /></section>;
  }
