...
function AdultDepressionSupportIndiaPage() {
  ...
  React.useEffect(() => {
    ...
    document.title = "Adult Depression Treatment in India | Depression Symptoms, Low Mood & Emotional Wellbeing | Manovaidya";
    ...
    metaDesc.content = "Looking for Adult Depression Treatment in India? Learn about depression symptoms, persistent low mood, emotional wellbeing and the Neuro-Ayurveda approach at Manovaidya.";
