...
const trustItems = [
  ...
  { label: "Expert Professionals", Icon: BadgeCheck },
  { label: "Evidence-Informed Care", Icon: Brain },
  { label: "Holistic & Personalised", Icon: HeartHandshake },
];
...
function AdultMentalWellnessHeroSection() {
  return (
    <section className="w-full bg-white">
      <div className="relative min-h-[650px] w-full overflow-hidden lg:min-h-[520px]">
        <img
          src={heroImage}
          alt="Adult Indian woman speaking with a mental health professional"
        ...
        <div className="relative z-10 flex min-h-[650px] flex-col px-5 pb-5 pt-6 sm:px-8 lg:min-h-[520px] lg:px-10 lg:pb-5 lg:pt-5">
          <div className="max-w-[610px]">
            ...
            <h1 className="mt-4 text-[40px] font-bold leading-[1.05] sm:text-[49px] lg:text-[48px] xl:text-[52px]">
              <span className="text-[#18181b]">Adult Mental Wellness</span>
              <br />
              <span className="text-[#8B43BA]">Support in India</span>
            </h1>

            <h2 className="mt-4 text-[19px] font-black leading-[1.35] sm:text-[22px]">
              <span className="text-[#18181b]">You Deserve to Feel Better, Think Clearer</span>
              <br />
              <span className="text-[#8B43BA]">&amp; Live a Fulfilling Life.</span>
            </h2>

            <p className="mt-3 max-w-[590px] text-[14px] font-bold leading-[1.55] text-[#18181b]/75 sm:text-[15px]">
              Expert care for stress, anxiety, depression, burnout and more.
              Compassionate. Confidential. Evidence-Informed.
            </p>
            ...
            <div className="mt-5 flex flex-col gap-4 sm:flex-row">
              ...
              <a
                href="/adult-mental-health-care-india"
...
export default AdultMentalWellnessHeroSection;
