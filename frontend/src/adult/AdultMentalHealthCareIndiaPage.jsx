      ...
      <section id={section.id} className="mt-9 overflow-hidden rounded-lg border border-[#eadff1] bg-[#7835A4] text-white">
        <div className="p-6 sm:p-8">
          ...
          <div className="mt-8 flex flex-wrap gap-4 border-t border-[#8e45bb] pt-6">
            <a href="tel:+917823894080" className="inline-flex h-12 items-center justify-center rounded-md bg-white px-8 text-[14px] font-black text-[#7835A4] transition hover:bg-[#fbf7ff]">Book Mental Health Assessment</a>
...
function AdultMentalHealthCareIndiaPage() {
  ...
  React.useEffect(() => {
    ...
    document.title = "Adult Mental Health Care in India | Mental Health Assessment & Emotional Wellbeing | Manovaidya";
    ...
    metaDesc.content = "Looking for Adult Mental Health Care in India? Learn about stress, anxiety, depression, burnout, sleep problems, emotional wellbeing and mental health assessments at Manovaidya.";
