...
function ConfusionDisorientationSupportPage() {
  ...
  React.useEffect(() => {
    document.title = "Confusion & Disorientation Treatment for Seniors in India | Cognitive Health & Healthy Ageing | Manovaidya";
    const description = "Looking for Confusion & Disorientation Treatment for Seniors in India? Learn about confusion in older adults, disorientation, possible causes, cognitive wellbeing and the Neuro-Ayurveda approach at Manovaidya.";
  ...
  return (
    <main className="min-h-screen bg-white text-[#1f1726]" style={{ font: '400 1.125rem/1.5 "Martel", serif' }}>
      ...
      <section className="sr-only whitespace-pre-wrap" aria-label="Full supplied confusion and disorientation content">
        {rawSourceContent}
      </section>
    </main>
  );
