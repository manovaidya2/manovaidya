...
const medicalWebPageSchema = {
  "@context": "https://schema.org",
  "@type": "MedicalWebPage",
  name: "Senior Mental Health Care & Healthy Ageing Support in India",
      ...
      <section id={section.id} className="mt-9 overflow-hidden rounded-lg border border-[#eadff1] bg-[#7835A4] text-white">
        <div className="p-6 sm:p-8">
          ...
          <div className="mt-8 flex flex-wrap gap-4 border-t border-[#8e45bb] pt-6">
            <a href="tel:+917823894080" className="inline-flex h-12 items-center justify-center rounded-md bg-white px-8 text-[14px] font-black text-[#7835A4] transition hover:bg-[#fbf7ff]">Book Senior Assessment</a>
...
function SeniorMentalHealthCareIndiaPage() {
  ...
  React.useEffect(() => {
    ...
    document.title = "Senior Mental Health Care in India | Healthy Ageing, Memory & Emotional Wellbeing | Manovaidya";
    ...
    metaDesc.content = "Looking for Senior Mental Health Care in India? Learn about healthy ageing, memory loss, dementia, Alzheimer's, emotional wellbeing, brain health and senior mental health assessments at Manovaidya.";
