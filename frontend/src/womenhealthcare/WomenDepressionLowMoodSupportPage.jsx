...
const pageLinks = [
  ...
  { label: "Hormonal Changes", id: "hormonal-changes" },
...
const articleLinkRules = [
  ...
  { pattern: /\blow mood\b/i, href: "/women-depression-low-mood-support-india" },
  ...
  { pattern: /\bemotional burnout\b/i, href: "/women-stress-management-mind-body-balance-india" },
  ...
  { pattern: /\bgrief\b/i, href: "/grief-bereavement-support-india" },
...
const sectionHeadingIds = {
  ...
  "Hormonal Changes & Depression": "hormonal-changes",
...
const articleStart = rawSourceContent.indexOf("All women have");
    ...
    <section className="mt-8 overflow-hidden rounded-[28px] bg-[#fbf5ef] shadow-[0_14px_30px_rgba(58,31,90,0.06)]">
      <div className="grid lg:grid-cols-[minmax(0,1fr)_360px]">
        <div className="p-6 sm:p-8">
          <p className="text-[11px] font-black uppercase tracking-[0.08em] text-[#8B43BA]">Depression & Low Mood</p>
        ...
        <div className="bg-[#f3eadb] p-6 sm:p-8">
          ...
          <p className="mt-3 text-[13px] font-semibold leading-6 text-[#111827]">
            Join our women's mental health newsletter for emotional wellbeing, sleep and resilience guidance.
          </p>
