...
import heroImage from "../images/women-self-esteem-body-image-support-india.png";
import doctorImage from "../images/doctorimg-2.jpeg";
import RelatedWomenHealthCarePages from "./RelatedWomenHealthCarePages";
import Seo from "../components/Seo";

const seoTitle = "Self-Esteem & Body Image Support for Women in India | Manovaidya";

const seoPageUrl = "https://manovaidya.org/women-self-esteem-body-image-support-india/";

const womenSelfEsteemFaqSchema = {
  "@context": "https://schema.org",
  "@type": "FAQPage",
  "mainEntity": [
    {
      "@type": "Question",
      "name": "1. What is self-esteem?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Self esteem is the way you feel and think about yourself. It is a sign of feeling valued, confident and having a sense of self worth. Self-esteem enables them to deal with difficulties, form positive relationships and make decisions with greater confidence."
      }
    },
    {
      "@type": "Question",
      "name": "2. What is body image?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Body image is the way a person sees, thinks and feels about his/her body. It contains ideas, feelings and beliefs about the body which could be true or false. Having a healthy body image means to accept your body as it is and not try to be a \"perfect\" body."
      }
    },
    {
      "@type": "Question",
      "name": "3. What is the difference between self-esteem and self-confidence?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Self-esteem is a general feeling of self-worth and self-confidence is the confidence in specific skills or situations. A woman can have self-confidence in her workplace, but still have low self-esteem or concerns about her body image. Although related, these are different aspects of emotional wellbeing."
      }
    },
    {
      "@type": "Question",
      "name": "4. What causes low self-esteem in women?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "A lack of self-esteem can result from a variety of life experiences, social factors and emotional issues. These can come from childhood criticism, bullying, bad relationship, comparison with social media, workplace stress, body image concerns, anxiety, depression and/or traumatic experiences. Individuals' experiences vary by woman."
      }
    },
    {
      "@type": "Question",
      "name": "5. What causes negative body image?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Unrealistic expectations of beauty, social media, frequent comparisons, remarks about appearance, cultural norms, before-and-after photos, pregnancy, ageing, and past emotional situations, including weight loss and gain, are potential contributors to negative body image. It can be more about the way someone feels and thinks about their body than how their body looks."
      }
    },
    {
      "@type": "Question",
      "name": "6. Can social media affect self-esteem?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. For others, the exposure to edited images, unrealistic beauty expectations and comparing oneself to others could lead to a negative impact on their self-esteem and body image. Regularly unplugging from social media and paying attention to personal health and wellness may lessen the amount of unhealthy comparison."
      }
    },
    {
      "@type": "Question",
      "name": "7. Can low self-esteem affect mental health?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. Low self-esteem can add to emotional stress and can be experienced along with anxiety or depression, chronic stress or other mental health issues. If negative self-beliefs start to impact on daily life, it may be helpful to seek professional assessment."
      }
    },
    {
      "@type": "Question",
      "name": "8. Can body image concerns affect relationships?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. Body image issues can affect self-confidence, relationships, social interactions and communication. For some women, the fear of appearing unattractive or lacking in self-worth can make social interactions uncomfortable or make it difficult to accept compliments, or make it necessary to receive constant reassurance."
      }
    },
    {
      "@type": "Question",
      "name": "9. How can I improve my self-esteem naturally?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "One strategy to developing healthy self-esteem is practicing self-compassion, avoiding negative comparisons, cultivating healthy relationships, identifying personal strengths, setting realistic goals, engaging in regular physical activity and seeking professional help if such negative self-beliefs become persistent or overwhelming."
      }
    },
    {
      "@type": "Question",
      "name": "10. How can I develop a healthier body image?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Improving body image is about how your body functions, rather than how it appears; about not comparing your body with an unrealistic standard of beauty; about practicing self-acceptance; and about finding enjoyable ways to be physically active and positive influences. Change is typically slow and takes time."
      }
    },
    {
      "@type": "Question",
      "name": "11. When should I seek professional help for self-esteem or body image concerns?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "If the low self-esteem or body image issue lasts for a few weeks, impacts work, relationships or daily life or causes emotional distress, it is advisable to seek professional guidance. Early support can be used to help discover causes and to build healthy coping strategies."
      }
    },
    {
      "@type": "Question",
      "name": "12. Can low self-esteem be improved?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. Self-esteem is malleable and can be enhanced over time. Self-awareness, supportive relationships, healthy lifestyle habits, psychological therapies and personalised professional guidance (when appropriate) are all ways in which many women build their confidence."
      }
    },
    {
      "@type": "Question",
      "name": "13. How does Manovaidya support women with self-esteem and body image concerns?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The process of support at Manovaidya does not just start with appearance or confidence, it begins with understanding the person. The Neuro-Ayurveda Development System is an organized assessment process for women to understand emotional wellbeing, self-worth, body image, lifestyle habits and behavioural patterns that could affect their confidence. We aim to promote emotional wellbeing, long term, in a whole person and individual approach."
      }
    },
    {
      "@type": "Question",
      "name": "14. Can self-esteem problems affect work and career?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. Low self esteem can affect your ability to communicate your ideas, stand out for leadership positions, apply for new jobs or make decisions. Raising self-esteem can have a positive impact on individual and career development."
      }
    },
    {
      "@type": "Question",
      "name": "15. When should I seek urgent mental health support?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "If one is experiencing emotional distress accompanied by thoughts of self-harm or suicide, if one thinks that he or she may hurt themselves or others, or if he or she thinks he or she or another person is in danger, seek immediate medical attention. In such cases, medical attention should not be postponed."
      }
    }
  ]
};

const womenSelfEsteemBreadcrumbSchema = {
  "@context": "https://schema.org/",
  "@type": "BreadcrumbList",
  "itemListElement": [
    {
      "@type": "ListItem",
      "position": 1,
      "name": "Self-Esteem & Body Image Support",
      "item": seoPageUrl
    }
  ]
};

const womenSelfEsteemMedicalWebPageSchema = {
  "@type": "MedicalWebPage",
  "name": "Self-Esteem & Body Image Support for Women in India",
  "description": "Self-esteem, body image and women's emotional wellbeing support at Manovaidya.",
  "url": seoPageUrl
};

const womenSelfEsteemPhysicianSchema = {
  "@type": "Physician",
  "name": "Dr. Ankush Garg",
...
const womenSelfEsteemSeoSchema = {
  "@context": "https://schema.org",
  "@graph": [
    womenSelfEsteemMedicalWebPageSchema,
    womenSelfEsteemFaqSchema,
    womenSelfEsteemBreadcrumbSchema,
    womenSelfEsteemPhysicianSchema,
  ],
};
...
const pageLinks = [
  ...
  { label: "Self-Esteem & Body Image", id: "understanding-self-esteem" },
  { label: "Low Self-Esteem", id: "low-self-esteem" },
  { label: "Healthy Confidence", id: "healthy-confidence" },
  ...
  { label: "Social Media", id: "social-media-self-esteem" },
  { label: "Self-Esteem vs Confidence", id: "self-esteem-vs-confidence" },
  { label: "Neuro-Ayurveda", id: "neuro-ayurveda-system" },
  { label: "Healthy Self-Worth", id: "healthy-self-esteem" },
...
const categories = [
  { label: "Self-Esteem in Women", count: 15, Icon: Sparkles },
  { label: "Body Image Issues", count: 12, Icon: UserRound },
  { label: "Low Self-Worth", count: 11, Icon: HeartHandshake },
  { label: "Self-Doubt", count: 10, Icon: Brain },
  { label: "Body Confidence", count: 9, Icon: ShieldCheck },
  { label: "Neuro-Ayurveda", count: 8, Icon: Sparkles },
];

const focusCards = [
  { label: "Low Self-Esteem", Icon: HeartHandshake },
  { label: "Poor Self-Confidence", Icon: Sparkles },
  { label: "Negative Body Image", Icon: UserRound },
  { label: "Body Dissatisfaction", Icon: ShieldCheck },
  { label: "Self-Doubt", Icon: Brain },
  { label: "Social Comparison", Icon: Users },
  { label: "Emotional Wellbeing", Icon: Activity },
  { label: "Healthy Self-Worth", Icon: CheckCircle2 },
];

const mindBodyHighlights = [
  { label: "Accept both strengths and weaknesses", Icon: HeartHandshake },
  { label: "Handle criticism without feeling worthless", Icon: ShieldCheck },
  { label: "Set healthy boundaries", Icon: Users },
  { label: "Value yourself beyond appearance", Icon: Sparkles },
  { label: "Reduce unhealthy comparison", Icon: Activity },
  { label: "Seek personalised support", Icon: Brain },
];

const symptomCards = [
  { title: "Emotional Symptoms", text: "Self-doubt, feeling inadequate, shame, embarrassment, fear of judgment, low confidence and feeling inferior to others.", Icon: HeartHandshake },
  { title: "Behavioural Changes", text: "Avoiding social situations, people-pleasing, seeking approval, avoiding photographs or mirrors and withdrawing from opportunities.", Icon: Users },
  { title: "Cognitive Symptoms", text: "Constant self-criticism, negative self-talk, perfectionism, fear of failure, overthinking and difficulty making decisions.", Icon: Brain },
  { title: "Body Image Concerns", text: "Dissatisfaction with appearance, comparison with others, focus on perceived flaws and feeling uncomfortable in one's body.", Icon: UserRound },
];

const causeCards = [
  { title: "Social & Relationship Influences", text: "Social media comparison, unrealistic beauty standards, childhood criticism, bullying and relationship experiences may affect self-worth.", Icon: Users },
  { title: "Life Changes & Body Changes", text: "Pregnancy, postpartum recovery, weight changes, medical conditions, ageing, hormonal changes and workplace pressure may influence body image.", Icon: Activity },
  { title: "Emotional Health Factors", text: "Anxiety, depression, trauma, chronic stress and negative self-perception may contribute to low self-esteem.", Icon: Brain },
];
...
const supportSteps = [
  ...
  { step: "Step 3", label: "Self-Worth Guidance", Icon: BookOpen },
  { step: "Step 4", label: "Neuro-Ayurveda System", Icon: Brain },
  { step: "Step 5", label: "Ongoing Support", Icon: CalendarCheck },
];

const balanceCards = [
  { title: "Practice Self-Compassion", Icon: HeartHandshake },
  { title: "Reduce Unhealthy Comparisons", Icon: ShieldCheck },
  { title: "Celebrate Small Achievements", Icon: Sparkles },
  { title: "Maintain Healthy Relationships", Icon: Users },
  { title: "Prioritise Physical & Emotional Health", Icon: Activity },
...
const trustCards = [
  ...
  { title: "Focus on Healthy Self-Worth & Emotional Confidence", Icon: Sparkles },
...
const sectionHeadingIds = {
  ...
  "How Low Self-Esteem & Body Image Concerns Can Affect Daily Life": "daily-life",
  "Social Media & Self-Esteem": "social-media-self-esteem",
  "Self-Esteem vs Self-Confidence": "self-esteem-vs-confidence",
...
function ContentSection({ section, sectionIndex, onCitationClick }) {
  ...
  const useCard = ["signs-symptoms", "causes", "daily-life", "healthy-self-esteem"].includes(section.id);
  ...
  return (
    ...
    >
      ...
      {section.id === "understanding-self-esteem" && (
        <div className="mt-5 rounded-lg border border-[#eadff1] bg-white px-4 py-4 shadow-[0_10px_28px_rgba(139,67,186,0.06)] sm:px-5 lg:flex lg:items-center lg:gap-7">
          <div className="lg:max-w-[43%] lg:shrink-0">
            ...
            <p className="mt-3 text-[13px] font-semibold leading-6 text-[#4b345d] sm:text-[14px]">
              Self-esteem and body image concerns may influence confidence, relationships, work, decisions, emotional wellbeing and daily functioning.
            </p>
          </div>
      ...
      {section.id === "early-recognition" && (
        <div className="mt-4 rounded-lg bg-[#fbf7ff] p-5">
          <p className="text-[13px] font-bold leading-6 text-[#4b345d]">
            Recognising self-esteem and body image concerns early allows women to develop healthier thinking patterns, strengthen emotional resilience and improve overall wellbeing.
          </p>
        </div>
      )}

      {section.id === "self-esteem-vs-confidence" && (
        <div className="mt-5 grid gap-4 sm:grid-cols-2">
          {[
            { title: "Self-Confidence", points: ["Relates to belief in your ability to handle specific tasks or situations", "May vary depending on work, relationships, skills or context", "Can grow through practice, preparation and experience"], Icon: Briefcase },
            { title: "Self-Esteem", points: ["Reflects overall sense of self-worth and personal value", "Can affect relationships, decisions, boundaries and emotional wellbeing", "Can improve when underlying emotional patterns are understood and supported"], Icon: Brain },
      ...
      {section.id === "healthy-self-esteem" && (
        <div className="mt-5 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
...
function WomenSelfEsteemBodyImageSupportPage() {
  ...
  return (
    <main className="min-h-screen bg-white text-[#1f1726]" style={{ font: '400 1.125rem/1.5 "Martel", serif' }}>
      <Seo 
        title={seoTitle} 
        description="Looking for Self-Esteem & Body Image Support for Women in India? Learn about low self-esteem, body image concerns, self-confidence, emotional wellbeing and the Neuro-Ayurveda approach at Manovaidya." 
        keywords="Low Self-Esteem, Poor Self-Confidence, Negative Body Image, Body Dissatisfaction, Self-Doubt, Social Comparison, Emotional Wellbeing, Healthy Self-Worth, Self-Esteem Support Women, Body Image Support India, Women's Mental Health, Self-Confidence Building, Social Media & Self-Esteem" 
        path="/women-self-esteem-body-image-support-india"
        schema={womenSelfEsteemSeoSchema}
      />
        ...
        <article className="min-w-0">
          <div className="relative overflow-hidden rounded-lg pb-6 pt-2 lg:grid lg:min-h-[360px] lg:grid-cols-[minmax(0,1fr)_minmax(330px,0.82fr)] lg:items-center lg:gap-8 lg:pb-8 lg:pt-3">
            <div className="relative z-10">
              <nav className="mb-3 flex flex-wrap items-center gap-2 text-[11px] font-bold text-[#7d7085]" aria-label="Article breadcrumb">
                ...
                <span>/</span>
                <span className="text-[#4b345d]">Self-Esteem & Body Image</span>
              </nav>
              <p className="text-[13px] font-black uppercase tracking-[0.08em] text-[#8B43BA]">Self-Esteem & Body Image</p>
            ...
            <figure className="relative z-10 mx-auto mt-8 w-full max-w-[520px] lg:mt-0 lg:max-w-none">
              ...
              <div className="-translate-y-[50px] overflow-hidden rounded-[48%_52%_46%_54%/58%_42%_58%_42%] border-[6px] border-white bg-[#fbf7ff] shadow-[0_18px_35px_rgba(139,67,186,0.12)] lg:-translate-y-[58px]">
                <img src={heroImage} alt="self-esteem and body image support for women in India at Manovaidya" className="h-[248px] w-full object-cover object-center sm:h-[315px] lg:h-[355px]" />
              </div>
            </figure>
          </div>
          ...
          <section id="introduction" className="mt-8">
            ...
            <div className="mt-5 rounded-lg border border-[#eadff1] bg-[#fbf9fd] p-5">
              <h3 className="text-[16px] font-black text-[#21142d]">Book a Structured Self-Esteem & Body Image Assessment</h3>
              <p className="mt-2 text-[13px] font-bold leading-6 text-[#51465a]">
                If constant self-criticism, low confidence or body image concerns have started affecting relationships, work or emotional wellbeing, understanding the underlying emotional patterns is an important first step.
              </p>
            </div>
          </section>
          ...
          <section id="faqs" className="mt-9">
            <h2 className="text-[20px] font-black text-[#17111f]">Frequently Asked Questions About Self-Esteem & Body Image</h2>
            ...
            <div className="p-7">
              ...
              <div className="mt-6">
                ...
                <ul className="grid gap-3 sm:grid-cols-2">
                  {["Book Consultation", "Speak With Our Team", "Get Personalized Guidance", "Self-Esteem & Body Image Assessment", "Healthy Self-Worth Support"].map((step) => (
        ...
        <div className="sticky top-24 max-h-[calc(100vh-6rem)] overflow-y-auto space-y-5 pb-5">
          ...
          <SidebarCard className="border-[#eadff1] bg-[#fbf9fd]" id="book-consultation-sidebar">
            ...
            <p className="mt-3 text-[12px] font-bold leading-5 text-[#5f5367]">
              Get structured self-esteem and body image support from Manovaidya.
            </p>
      ...
      <section className="border-y border-[#eadff1] bg-white">
        <div className="mx-auto grid max-w-[1440px] gap-5 px-4 py-6 sm:px-6 lg:grid-cols-[1fr_460px] lg:items-center lg:px-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-[19px] font-black text-[#21142d]">Need Personalized Self-Esteem & Body Image Guidance?</h2>
              <p className="mt-1 text-[13px] font-bold text-[#5f5367]">Connect with Manovaidya for structured self-esteem, body image and emotional wellbeing support.</p>
            </div>
          </div>
...
export default WomenSelfEsteemBodyImageSupportPage;
