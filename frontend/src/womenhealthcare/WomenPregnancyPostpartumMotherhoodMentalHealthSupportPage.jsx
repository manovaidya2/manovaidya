...
import heroImage from "../images/women-pregnancy-postpartum-motherhood-mental-health-support-india.png";
import doctorImage from "../images/doctorimg-2.jpeg";
import RelatedWomenHealthCarePages from "./RelatedWomenHealthCarePages";
import Seo from "../components/Seo";

const seoTitle = "Pregnancy, Postpartum & Motherhood Mental Health Support in India";

const seoPageUrl = "https://www.manovaidya.org/women-pregnancy-postpartum-motherhood-mental-health-india/";

const womenPregnancyFaqSchema = {
  "@context": "https://schema.org",
  "@type": "FAQPage",
  "mainEntity": [
    {
      "@type": "Question",
      "name": "1. Is it normal to feel anxious during pregnancy?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. Pregnancy brings about physical changes and concerns for childbirth, the health of the baby and becoming a parent, which many women experience some anxiety about. It is normal to have a little and slight concern. If anxiety is persistent, overwhelming or if it is interfering with sleep, daily functioning or relationships, professional help is recommended."
      }
    },
    {
      "@type": "Question",
      "name": "2. How does pregnancy affect mental health?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "There are hormonal, physical and emotional changes associated with pregnancy which can affect mental wellbeing. Women may have mood swings, emotional sensitivity, anxiety or stress, or they may adapt without significant emotional challenges. Each pregnancy is unique."
      }
    },
    {
      "@type": "Question",
      "name": "3. What are the common emotional changes during pregnancy?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Some emotional changes that's common are mood swings, heightened sensitivity, excitement, worry, irritability, emotional ups and down, and trouble sleeping or fears about childbirth or parenthood. These changes are typically temporary, however, if emotional distress remains, it is important to seek assistance from a health care professional."
      }
    },
    {
      "@type": "Question",
      "name": "4. What are baby blues?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Baby blues are temporary emotional changes that many mothers experience during the first few days after childbirth. Symptoms can range from being very tearful, to experiencing mood swings, irritation, feeling overwhelmed and emotional sensitivity. Baby blues typically go away in two weeks following delivery."
      }
    },
    {
      "@type": "Question",
      "name": "5. What is the difference between baby blues and postpartum depression?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Baby blues are short-lasting, normal emotional changes that typically pass within a couple of weeks after giving birth. A recognized medical condition, postpartum depression is defined by more severe or persistent symptoms like sadness, anxiety, loss of interest and an inability to connect with the baby or extreme emotional distress. It is crucial to have a professional assessment when symptoms persist or get worse."
      }
    },
    {
      "@type": "Question",
      "name": "6. What are the signs of postpartum depression?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Some mothers may suffer from sadness, anxiety, excessive crying, a sense of hopelessness, loss of interest in activities, inability to bond with the infant, guilt feelings, and emotional overwhelm, or a combination of these symptoms. When these signs continue or get in the way of daily living, it is advisable to have a professional assessment."
      }
    },
    {
      "@type": "Question",
      "name": "7. Can pregnancy or motherhood affect sleep?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. Many changes in the body and physical discomfort during pregnancy and caring for a newborn can impact sleep quality. Poor sleep can also have an effect on emotional state, concentration and energy levels. Keeping healthy sleep patterns and getting help if necessary is helpful."
      }
    },
    {
      "@type": "Question",
      "name": "8. Can motherhood affect relationships?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. Many aspects of daily life, responsibilities and communication with family members and partners are altered after the birth of a child. Some mothers might feel emotional distance, less personal time and more challenges in balancing her various roles. It is a good idea to have open communication and emotional support in this period."
      }
    },
    {
      "@type": "Question",
      "name": "9. How can I support my emotional wellbeing during pregnancy?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Emotional wellbeing support can also involve getting enough rest, eating healthy foods, doing exercises as recommended by the health care provider, practicing relaxation techniques and accepting assistance from family members and thorough conversations about emotional matters with trusted health care professionals."
      }
    },
    {
      "@type": "Question",
      "name": "10. How can new mothers manage motherhood stress?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "When possible, healthy sleep habits, support, sharing parenthood, realistic expectations, self-care, and professional guidance when emotional stress are too great can help adjust mothers to parenthood more comfortably."
      }
    },
    {
      "@type": "Question",
      "name": "11. When should I seek professional help during pregnancy or after childbirth?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "If emotional distress persists for more than a brief period, intensifies, is interfering with sleep, relationships, bonding with the baby, work or daily functioning, or is causing high anxiety or sadness for a prolonged time, then professional help should be sought."
      }
    },
    {
      "@type": "Question",
      "name": "12. Can maternal mental health affect family wellbeing?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. Emotional health is an essential part of a mother's overall health and wellness and can contribute to family relationships, parenting experiences and the family environment. Maternal mental health is a family affair."
      }
    },
    {
      "@type": "Question",
      "name": "13. How does Manovaidya support women during pregnancy and motherhood?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "At Manovaidya, support starts with the unique journey of each woman, not just on the symptoms. We provide structured assessment, personalized guidance and the Neuro-Ayurveda Development System that helps women understand about emotional wellbeing, lifestyle habits, sleeping pattern, hormonal changes and behavioural pattern which can affect pregnancy, postpartum adjustment and motherhood. We aim to provide a holistic and tailored approach to facilitate mothers' long-term emotional well-being."
      }
    },
    {
      "@type": "Question",
      "name": "14. Can pregnancy-related emotional challenges be managed?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. With proper care, many women get better. This may involve healthy lifestyle habits, emotional support, psychological therapies, stress management strategies and, as appropriate, medical treatment suggested by qualified health care providers. Personalised care should always be provided."
      }
    },
    {
      "@type": "Question",
      "name": "15. When to look for emergency medical care while pregnant or after birth?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "If you have thoughts of hurting yourself or your baby, think you might hurt yourself or your baby, have a lot of confusion, hallucinations, too much agitation or cannot keep yourself or your baby safe, you should seek immediate medical attention. In such circumstances prompt medical assessment is needed and should not be overlooked."
      }
    }
  ]
};

const womenPregnancyBreadcrumbSchema = {
  "@context": "https://schema.org/",
  "@type": "BreadcrumbList",
  "itemListElement": [
    {
      "@type": "ListItem",
      "position": 1,
      "name": "Pregnancy, Postpartum & Motherhood",
      "item": seoPageUrl
    }
  ]
};

const womenPregnancyMedicalWebPageSchema = {
  "@type": "MedicalWebPage",
  "name": "Pregnancy, Postpartum & Motherhood Mental Health Support for Women in India",
  "description": "Pregnancy, postpartum and motherhood mental health support for women's emotional wellbeing at Manovaidya.",
  "url": seoPageUrl
};

const womenPregnancyPhysicianSchema = {
  "@type": "Physician",
  "name": "Dr. Ankush Garg",
...
const womenPregnancySeoSchema = {
  "@context": "https://schema.org",
  "@graph": [
    womenPregnancyMedicalWebPageSchema,
    womenPregnancyFaqSchema,
    womenPregnancyBreadcrumbSchema,
    womenPregnancyPhysicianSchema,
  ],
};
...
const pageLinks = [
  ...
  {
    "label": "Pregnancy Mental Health",
    "id": "understanding-pregnancy"
  },
  {
    "label": "Pregnancy Changes",
    "id": "emotional-changes-pregnancy"
  },
  {
    "label": "Baby Blues",
    "id": "baby-blues"
  ...
  {
    "label": "Postpartum Wellbeing",
    "id": "postpartum-emotional-wellbeing"
  },
  {
    "label": "Motherhood Changes",
    "id": "motherhood-emotional-changes"
  },
  {
  ...
  },
  {
    ...
    "id": "pregnancy-anxiety-vs-worries"
  },
  {
...
const categories = [
  { label: "Pregnancy Anxiety", count: 15, Icon: Brain },
  { label: "Baby Blues", count: 14, Icon: CloudRain },
  { label: "Postpartum Emotional Health", count: 13, Icon: HeartHandshake },
  { label: "Motherhood Stress", count: 12, Icon: Users },
  { label: "Maternal Mental Health", count: 11, Icon: UserRound },
  { label: "Neuro-Ayurveda", count: 8, Icon: Sparkles },
];

const focusCards = [
  { label: "Pregnancy Anxiety", Icon: Brain },
  { label: "Pregnancy Emotional Changes", Icon: Activity },
  { label: "Maternal Wellbeing During Pregnancy", Icon: HeartHandshake },
  { label: "Baby Blues", Icon: CloudRain },
  { label: "Postpartum Emotional Health", Icon: ShieldCheck },
  { label: "Motherhood Stress", Icon: Users },
  { label: "New Mother's Maternal Wellbeing", Icon: UserRound },
  { label: "Maternal Mental Health", Icon: Sparkles },
];

const mindBodyHighlights = [
  { label: "Mood changes", Icon: CloudRain },
  { label: "Anxiety or excessive worry", Icon: Brain },
  { label: "Sleep disturbance", Icon: Activity },
  { label: "Emotional exhaustion", Icon: HeartHandshake },
  { label: "Feeling overwhelmed", Icon: Users },
  { label: "Need for reassurance and support", Icon: ShieldCheck },
];

const symptomCards = [
  { title: "Emotional Symptoms", text: "Anxiety, mood changes, crying spells, irritability, sadness, emotional exhaustion, overwhelm and feeling disconnected.", Icon: HeartHandshake },
  { title: "Cognitive Symptoms", text: "Excessive worry, racing thoughts, self-doubt, difficulty concentrating, fear of not being a good mother and negative thinking.", Icon: Brain },
  { title: "Behavioural Changes", text: "Social withdrawal, difficulty asking for help, reduced self-care, changes in communication and difficulty managing responsibilities.", Icon: Users },
  { title: "Physical & Sleep Changes", text: "Fatigue, poor sleep, appetite changes, restlessness and body tension. Persistent physical symptoms should always be medically evaluated.", Icon: Activity },
];

const causeCards = [
  { title: "Hormonal & Body Changes", text: "Pregnancy, childbirth, recovery, sleep disruption and physical changes may influence emotional wellbeing.", Icon: Activity },
  { title: "Life Transition & Responsibilities", text: "New roles, caregiving pressure, relationship changes, family expectations and parenting responsibilities may increase stress.", Icon: Users },
  { title: "Emotional & Support Factors", text: "Past mental health concerns, lack of rest, limited support, anxiety and chronic stress may affect maternal wellbeing.", Icon: Brain },
];
...
const supportSteps = [
  ...
  { step: "Step 3", label: "Maternal Wellbeing Guidance", Icon: BookOpen },
  { step: "Step 4", label: "Neuro-Ayurveda System", Icon: Brain },
  { step: "Step 5", label: "Ongoing Support", Icon: CalendarCheck },
];

const balanceCards = [
  { title: "Prioritise Rest and Recovery", Icon: Activity },
  { title: "Build Emotional Support", Icon: HeartHandshake },
  { title: "Communicate Needs Clearly", Icon: Users },
  { title: "Support Healthy Nutrition", Icon: ShieldCheck },
  { title: "Practice Gentle Relaxation", Icon: Sparkles },
  { title: "Seek Professional Guidance", Icon: Brain },
];

const trustCards = [
  { title: "Structured Neuro-Ayurveda Development System", Icon: Brain },
  { title: "Personalized Assessment Before Recommendations", Icon: Search },
  ...
  { title: "Guidance by Dr. Ankush Garg", Icon: ShieldCheck },
...
const sectionHeadingIds = {
  ...
  "What Can Influence Maternal Emotional Wellbeing?": "causes",
  "Why Early Recognition Matters": "early-recognition",
  "How Pregnancy & Motherhood Can Affect Daily Life": "daily-life",
...
function ContentSection({ section, sectionIndex, onCitationClick }) {
  ...
  return (
    ...
    >
      ...
      {section.id === "understanding-pregnancy" && (
        <div className="mt-5 rounded-lg border border-[#eadff1] bg-white px-4 py-4 shadow-[0_10px_28px_rgba(139,67,186,0.06)] sm:px-5 lg:flex lg:items-center lg:gap-7">
          <div className="lg:max-w-[43%] lg:shrink-0">
            ...
            <p className="mt-3 text-[13px] font-semibold leading-6 text-[#4b345d] sm:text-[14px]">
              Pregnancy, postpartum and motherhood emotional changes may affect mood, sleep, confidence, relationships, caregiving and daily functioning.
            </p>
          </div>
      ...
      {section.id === "emotional-changes-pregnancy" && (
      ...
      {section.id === "early-recognition" && (
        <div className="mt-4 rounded-lg bg-[#fbf7ff] p-5">
          <p className="text-[13px] font-bold leading-6 text-[#4b345d]">
            Recognising pregnancy, postpartum and motherhood emotional changes early allows women to seek support before emotional wellbeing, sleep, confidence or daily functioning becomes significantly affected.
          </p>
        </div>
      )}

      {section.id === "pregnancy-anxiety-vs-worries" && (
        <div className="mt-5 grid gap-4 sm:grid-cols-2">
          {[
            { title: "Normal Pregnancy Worries", points: ["Occasional worry linked to appointments, health, delivery or preparation", "Improves with reassurance, rest, information and support", "Does not significantly interfere with daily functioning"], Icon: Briefcase },
            { title: "Pregnancy Anxiety", points: ["Persistent or excessive worry that becomes difficult to control", "Fear, restlessness, poor sleep or repeated reassurance seeking", "May interfere with daily life and benefit from professional assessment"], Icon: Brain },
...
function WomenPregnancyPostpartumMotherhoodMentalHealthSupportPage() {
  ...
  return (
    <main className="min-h-screen bg-white text-[#1f1726]" style={{ font: '400 1.125rem/1.5 "Martel", serif' }}>
      <Seo 
        title={seoTitle} 
        description="Looking for Pregnancy, Postpartum & Motherhood Mental Health Support in India? Learn about pregnancy anxiety, baby blues, postpartum emotional health, motherhood stress and the Neuro-Ayurveda approach at Manovaidya." 
        keywords="Pregnancy Anxiety, Pregnancy Emotional Changes, Maternal Wellbeing, Baby Blues, Postpartum Emotional Health, Postpartum Depression, Motherhood Stress, Maternal Mental Health, Women's Mental Health, Pregnancy Mental Health India, New Mother Support, Postpartum Anxiety, Emotional Wellbeing During Pregnancy" 
        path="/women-pregnancy-postpartum-motherhood-mental-health-india"
        schema={womenPregnancySeoSchema}
      />
        ...
        <article className="min-w-0">
          <div className="relative overflow-hidden rounded-lg pb-6 pt-2 lg:grid lg:min-h-[360px] lg:grid-cols-[minmax(0,1fr)_minmax(330px,0.82fr)] lg:items-center lg:gap-8 lg:pb-8 lg:pt-3">
            <div className="relative z-10">
              <nav className="mb-3 flex flex-wrap items-center gap-2 text-[11px] font-bold text-[#7d7085]" aria-label="Article breadcrumb">
                ...
                <span>/</span>
                <span className="text-[#4b345d]">Pregnancy, Postpartum & Motherhood</span>
              </nav>
              <p className="text-[13px] font-black uppercase tracking-[0.08em] text-[#8B43BA]">Pregnancy, Postpartum & Motherhood</p>
            ...
            <figure className="relative z-10 mx-auto mt-8 w-full max-w-[520px] lg:mt-0 lg:max-w-none">
              ...
              <div className="-translate-y-[50px] overflow-hidden rounded-[48%_52%_46%_54%/58%_42%_58%_42%] border-[6px] border-white bg-[#fbf7ff] shadow-[0_18px_35px_rgba(139,67,186,0.12)] lg:-translate-y-[58px]">
                <img src={heroImage} alt="pregnancy postpartum and motherhood mental health support for women in India at Manovaidya" className="h-[248px] w-full object-cover object-center sm:h-[315px] lg:h-[355px]" />
              </div>
            </figure>
          </div>
          ...
          <section id="introduction" className="mt-8">
            ...
            <div className="mt-5 rounded-lg border border-[#eadff1] bg-[#fbf9fd] p-5">
              <h3 className="text-[16px] font-black text-[#21142d]">Book a Structured Pregnancy & Motherhood Mental Health Assessment</h3>
              <p className="mt-2 text-[13px] font-bold leading-6 text-[#51465a]">
                If ongoing pregnancy anxiety, postpartum emotional changes, motherhood stress or emotional exhaustion have started affecting confidence, sleep, work or overall quality of life, understanding the underlying emotional patterns is an important first step.
              </p>
            </div>
          </section>
          ...
          <section id="faqs" className="mt-9">
            <h2 className="text-[20px] font-black text-[#17111f]">Frequently Asked Questions About Pregnancy, Postpartum & Motherhood Mental Health</h2>
            ...
            <div className="p-7">
              ...
              <div className="mt-6">
                ...
                <ul className="grid gap-3 sm:grid-cols-2">
                  {["Book Consultation", "Speak With Our Team", "Get Personalized Guidance", "Pregnancy & Motherhood Mental Health Assessment", "Postpartum Emotional Wellbeing Support"].map((step) => (
        ...
        <div className="sticky top-24 max-h-[calc(100vh-6rem)] overflow-y-auto space-y-5 pb-5">
          ...
          <SidebarCard className="border-[#eadff1] bg-[#fbf9fd]" id="book-consultation-sidebar">
            ...
            <p className="mt-3 text-[12px] font-bold leading-5 text-[#5f5367]">
              Get structured pregnancy, postpartum and motherhood mental health support from Manovaidya.
            </p>
      ...
      <section className="border-y border-[#eadff1] bg-white">
        <div className="mx-auto grid max-w-[1440px] gap-5 px-4 py-6 sm:px-6 lg:grid-cols-[1fr_460px] lg:items-center lg:px-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-[19px] font-black text-[#21142d]">Need Personalized Pregnancy & Motherhood Mental Health Guidance?</h2>
              <p className="mt-1 text-[13px] font-bold text-[#5f5367]">Connect with Manovaidya for structured pregnancy, postpartum and motherhood mental health support.</p>
            </div>
          </div>
...
export default WomenPregnancyPostpartumMotherhoodMentalHealthSupportPage;
