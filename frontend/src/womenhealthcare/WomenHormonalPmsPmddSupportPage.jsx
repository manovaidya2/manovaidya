...
const articleLinkRules = [
  ...
  { pattern: /\bPremenstrual Syndrome\b/i, href: "/women-hormonal-pms-pmdd-support-india" },
  { pattern: /\bPremenstrual Dysphoric Disorder\b/i, href: "/women-hormonal-pms-pmdd-support-india" },
  { pattern: /\bPMS\b/i, href: "/women-hormonal-pms-pmdd-support-india" },
  { pattern: /\bPMDD\b/i, href: "/women-hormonal-pms-pmdd-support-india" },
  ...
  { pattern: /\bDepression & Low Mood\b/i, href: "/women-depression-low-mood-support-india" },
  ...
  { pattern: /\bSelf-Esteem\b/i, href: "/self-esteem-confidence-support-india" },
...
const sectionHeadingIds = {
  ...
  "Supporting Emotional Wellbeing During Hormonal Changes": "emotional-wellbeing",
  ...
  "Why Women Across India is choosing Manovaidya?": "why-women-choose",
...
const articleStart = rawSourceContent.indexOf("A woman's life goes");
    ...
    <section className="mt-8 overflow-hidden rounded-[28px] bg-[#fbf5ef] shadow-[0_14px_30px_rgba(58,31,90,0.06)]">
      <div className="grid lg:grid-cols-[minmax(0,1fr)_360px]">
        <div className="p-6 sm:p-8">
          <p className="text-[11px] font-black uppercase tracking-[0.08em] text-[#8B43BA]">Hormonal & PMS/PMDD</p>
        ...
        <div className="bg-[#f3eadb] p-6 sm:p-8">
          ...
          <p className="mt-3 text-[13px] font-semibold leading-6 text-[#111827]">
            Join our women's mental health newsletter for PMS, PMDD and hormonal wellbeing guidance.
          </p>
